...
from processing_helper import draw_single_char_by_font, draw_example, CHAR_SIZE, CANVAS_SIZE
...
parser.add_argument('--src_font', default='./font_ttf/SimSun.ttf', help='path of the source font')
parser.add_argument('--fonts_dir', default='./font_ttf', help='dir path of the target fonts')
...
parser.add_argument('--save_dir', default="./pickled_data", help='path to save pickled files')
